        ...
        <section class="mt-8">
            ...
            <div class="panel mt-5 overflow-hidden">
                ...
                <div class="divide-y divide-zinc-100 px-5">
                    @can('super-admin')
                        <a href="{{ route('organization.edit') }}" wire:navigate class="flex items-center gap-4 py-5"><span class="grid size-9 shrink-0 place-items-center rounded-full bg-[#fff0d5]"><flux:icon icon="building-office-2" class="size-4"/></span><div class="flex-1"><h3 class="text-sm font-medium">Add your team identity</h3><p class="mt-1 text-xs text-zinc-500">Set your company name and logo.</p></div><flux:icon icon="arrow-up-right" class="size-4 text-zinc-400"/></a>
