...
<body class="min-h-screen bg-[#f6f7f4] text-zinc-950 antialiased">
    ...
    <footer class="mx-auto flex max-w-7xl flex-wrap justify-between gap-3 px-5 py-8 text-[11px] text-zinc-500 sm:px-10"><span>Startsuite · Platform administration</span><a href="{{ route('home') }}">Visit website <flux:icon icon="arrow-up-right" class="inline-block size-4 shrink-0 align-text-bottom" aria-hidden="true" /></a></footer>
    @fluxScripts
</body>
</html>
